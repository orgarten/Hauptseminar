...
\noindent Wir schreiben zuerst die die KKF als Faltung. Danach transformieren wir die Faltung in den Frequenzbereich. Durch geschicktes Erweitern und Substitution findet man einen Ausdruck, um die KKF im Frequenzbereich zu berechnen.
...
\begin{figure}[h] 
  \centering
     \includegraphics[width=0.4\textwidth]{Faltung.jpg}
