...
Die Kreuzkorrelationsfunktion (KKF) ist als aus zwei verschiedenen Funktionen gebildeter Erwartungswert definiert. Hier werden die Formeln f"ur die Korrelation der Prozesse \textbf{X} und eines Prozesses \textbf{Y} angegeben. 
